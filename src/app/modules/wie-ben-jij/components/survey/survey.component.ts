...
export class SurveyComponent {
  ...
  question_1: Question = { question: 'Welke snack eet jij met carnaval?', answer_1: 'Frikandel maar wel een speciale' , answer_2: 'Balletjes van de koniging', answer_3: 'Falaffel in mn waffel', answer_4: 'Heel veel bruine boterhammen' };
  ...
  question_4: Question = { question: 'Wat is jouw favoriete carnavals nummer?', answer_1: 'Zak es lekker door', answer_2: 'Er staat een paard in de gang', answer_3: 'Bloemetjes gordijn', answer_4: 'Potentie' };
  ...
  question_6: Question = { question: 'Bij welke carnavalvereniging zou jij zitten?', answer_1: 'CV de padvinders', answer_2: 'CV de blauw wit uilen', answer_3: 'CV weg er mee', answer_4: 'CV experience' };
